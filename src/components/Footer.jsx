    ...
    <footer className="footer">
      ...
      <div className="container footer__inner">
        ...
        <p className="footer__tagline">
          "Nothing is true, everything is permitted." — Built with ☕ &amp; ❤️ using React
        </p>
        ...
        <div className="footer__bottom">
          <span>© {year} Nguyen Nam. All rights reserved.</span>
          <a href="https://github.com/namnguyen2608" target="_blank" rel="noopener noreferrer" className="footer__gh">
